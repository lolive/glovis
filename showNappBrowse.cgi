...
# scene id, flightline(path), and station(row) passed in
...
# untaint the flightline and station
...
# build the directory name for this sensor/flightline/station
my $dirname = "napp/" . $flightline . "/" . $station;
