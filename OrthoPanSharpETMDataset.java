// OrthoPanSharpETMDataset.java defines a class to encapsulate the
// Orthorectified ETM+ Pansharpened dataset details.
//------------------------------------------------------------------
...
public class OrthoPanSharpETMDataset extends Sensor
{
    ...
    // Constructor
    OrthoPanSharpETMDataset(imgViewer applet)
    {
        super(applet,"ETM+ Pan (1999-2003)","ortho/pansharp_etm",
              "ESAT_ETM_PAN", "showOrthoBrowse.cgi",
              "showOrthoMetadata.cgi","USGS_logo.gif",
              "http://www.usgs.gov",
              "https://lta.cr.usgs.gov/Tri_Dec_GLOO",
              null, "Enter a 21 character scene ID",
    ...
    // method to return a nominal OrthoPanSharp scene size in meters
    //---------------------------------------------------------------
