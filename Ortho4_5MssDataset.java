// Ortho4_5MssDataset.java defines a class to encapsulate the
// Lansats 4-5 MSS Ortho dataset details.
//-----------------------------------------------------------------
...
public class Ortho4_5MssDataset extends Sensor
{
    ...
    // Constructor
    Ortho4_5MssDataset(imgViewer applet, String sensorName, String datasetName,
                       boolean isDownloadable)
    {
        super(applet, sensorName, "ortho/mss4_5", datasetName,
              "showOrthoBrowse.cgi",
              "showOrthoMetadata.cgi","USGS_logo.gif",
              "http://www.usgs.gov",
              "https://lta.cr.usgs.gov/Tri_Dec_GLOO",
              null, "Enter a 20 character scene ID",
