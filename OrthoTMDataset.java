// OrthoTMDataset.java defines a class to encapsulate the Ortho TM
// dataset details.
//-----------------------------------------------------------------
...
public class OrthoTMDataset extends Sensor
{
    ...
    // Constructor
    OrthoTMDataset(imgViewer applet, String sensorName, String datasetName,
                   String productInfoUrl, boolean isDownloadable)
    {
        super(applet, sensorName, "ortho/tm", datasetName,
